...
using Carros.Venda.Api.Configuration;
using Carros.Venda.Infra.Data;
using Carros.Venda.Domain.Interfaces;
using Carros.Venda.Infra.Data.Repository;
using Carros.Venda.Api.AutoMapper;
using Carros.Venda.Application.AutoMapper;
...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "Compra de carros", Version = "v1" });
